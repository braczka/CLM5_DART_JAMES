...
# BMR 7/26/21
# Simulation identical to clm5_assim_maxstate_diag using DART_git version:
# 
#
# commit a97102c633eb86735a31e04105b6b2bab13dd01e
# Merge: 5bd5c9a 83f4e95
# Author: braczka <brett.raczka@utah.edu>
# Date:   Wed May 13 14:27:21 2020 -0600
#
# Merge branch 'timhoar-monthly_diags' into CLM5_WUSA
#
# commit 83f4e958ecfa1c459452e688d68c1943d8788049
# Author: Tim Hoar <thoar@ucar.edu>
# Date:   Thu May 7 15:06:12 2020 -0600
#
# This allows for diagnostics on a monthly timescale -- with restrictions.
#             
# The bin centers can be on the same day of each month (i.e. Feb 30 is not allowed)
# so center the bin on the first day of the month and avoid problems.
# The bin separation can be monthly, that's well defined.
# Monthly bin widths are not so well-defined, so it is not allowed.
#
# commit 5bd5c9ab97e220f77aba483f573f332c1eb30aba
# Merge: 39308fa 5796bf9
# Author: Tim Hoar <thoar@ucar.edu>
# Date:   Tue Apr 28 13:45:57 2020 -0600
#
# Merge pull request #14 from timhoar/public_pr13
#                                    
# fixing logic of obs_seq_to_netcdf
...
# processors is cpus assigned per instance. For 1 assimilation --> 80 cpus.
# # for Kingspeak 16 cpus/node:  So  5 nodes per 80 cpus
# # For Notchpeak 52 cpus/node:  So ~1.5 nodes per 80 cpus
...
if (${num_instances} == 1) then
   ...
   setenv CASE clm5_build_e${num_instances}
endif
...
setenv SourceModDir   ~/SourceMods_CLM5.0.03/SourceMods

## Confirm lnd_import_export.F90; ~/biogeochem/CNBalanceCheckMod.F90; ~/biogeochem/CNPrecisionControlMod.F90
## ~/biogeophys/Photosynthesis.F90; ~/biogeophys/CanopyFluxesMod.F90
...
setenv cesmdata         /scratch/general/nfs1/${USER}/inputdata
setenv cesmroot         /uufs/chpc.utah.edu/common/home/${USER}/${cesmtag}
setenv caseroot         /uufs/chpc.utah.edu/common/home/lin-group10/bmr/${cesmtag}/${CASE}
setenv cime_output_root /scratch/general/nfs1/${USER}/${cesmtag}/${CASE}
...
setenv dartroot               /uufs/chpc.utah.edu/common/home/lin-group10/bmr/DART
setenv baseobsdir             /uufs/chpc.utah.edu/common/home/lin-group10/bmr/obstodart/products
...
setenv refcase      clm5_spin80_newICb
setenv refyear      2037
setenv refmon       01
setenv refday       01
setenv reftod       00000
...
setenv stagedir /uufs/chpc.utah.edu/common/home/u0981255/sc2/clm5_spin80_newICb/run
...
# Can only use h1nsteps formula when stop_option is a predictable time length
# e.g. days (not months)
# Will manually set this in user_nl_clm
