...
## BMR Customize this for monthly updates
set BASEOBSDIR = /uufs/chpc.utah.edu/common/home/lin-group10/bmr/obstodart/products
set datehfd = `printf %04d_%02d_%02d_00_00_00 ${LND_YEAR} ${LND_MONTH} ${LND_DAY}` 
...
# BMR Edited out round robin task approach
...
# BMR  creating custom monthly history files to get file time-stamp correct 
...
set     LND_HISTORY_FILENAME = ${CASE}.clm2_0001.h0.${LND_YEAR2}-${LND_MONTH2}.nc
set LND_VEC_HISTORY_FILENAME = ${CASE}.clm2_0001.h2.${LND_YEAR2}-${LND_MONTH2}.nc
...
# BMR keeping the fill_inflation_restart portion in for now
# Before I had issues with fill_inflation_restart so I turned
# off adaptive inflation in first time step
...
while ($ensmembernum <= $ENSEMBLE_SIZE)
   ...
   if (  -e   ${CASE}.clm2_${ensmembernum2}.h2.${LND_YEAR2}-${LND_MONTH2}.nc ) then
